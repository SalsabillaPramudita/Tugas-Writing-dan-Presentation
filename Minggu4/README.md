...
- 2 cara memasang bootstrap
  ...
  - Install Bootstrap Secara Offline
      - Download terlebih dahulu file bootstrap melalui laman resminya. Selanjutnya klik Extract Here.
      - Selanjutnya bukalah teks editor
      - Selanjutnya simpanlah file tersebut dengan cara klik menu File lalu pilih menu Save.
      - Simpanlah file tersebut didalam folder bootstrap. Kemudian berikan nama file index.html. Pastikan bahwa Anda harus memberikan ekstensinya menjadi HTML. Lalu klik tombol Save.
      - script di html
        ```
